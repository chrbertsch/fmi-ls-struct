...
The `causality` of such a variable is `parameter` if the grid is meant to be changed after the FMU got created.
...
The indices latexmath:[1, \dots, n] are the serialization indices of the nonscalar input variable and n is the product of dimension sizes.
