...
Optionally, for each `domain` variable at most one array variable (typically an input or a local variable) can be referenced that represents calculated output value of the map.
...
=== Referencing Modelica library Combitables
...
==== Referencing Modelica library CombiTable1d
...
==== Referencing Modelica library CombiTable2d
